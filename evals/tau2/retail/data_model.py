"""Closely adapted from https://github.com/sierra-research/tau2-bench/blob/377cecff73b873e63430a0acfce00e0eff024855/src/tau2/domains/retail/data_model.py"""
...
class Paypal(PaymentMethodBase):
    source: Literal["paypal"] = Field(  # type: ignore
...
class RetailDB(DB):
    ...
    orders: dict[str, Order] = Field(
        default_factory=dict, description="Dictionary of all orders indexed by order ID"
    )
